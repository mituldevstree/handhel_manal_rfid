...
@AndroidEntryPoint
class BottomSheetAssetType : BaseHeaderBottomSheet() {
    ...
    override fun onClick(view: View?) {
        ...
        when (view) {
            binding.btnAdd -> {
                hideBottomSheet()
                (activity as AddPartActivity).openAddAssetTypeActivity({
                    if (it.resultCode != Activity.RESULT_OK) return@openAddAssetTypeActivity
    ...
    override fun show(activity: FragmentActivity): BaseBottomSheet? {
        return super.show(activity, BottomSheetAssetType::class.java.simpleName)
    }
    ...
    companion object {
        ...
        ): BottomSheetAssetType {
            val fragment = BottomSheetAssetType()
