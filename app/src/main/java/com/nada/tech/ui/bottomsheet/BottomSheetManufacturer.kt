...
@AndroidEntryPoint
class BottomSheetManufacturer : BaseHeaderBottomSheet(), View.OnClickListener {
    ...
    override fun onClick(view: View?) {
        ...
        when (view) {
            binding.btnAdd -> {
                hideBottomSheet()
                (activity as AddPartActivity).openAddManufactorActivity({
                    if (it.resultCode != Activity.RESULT_OK) return@openAddManufactorActivity
    ...
    override fun show(activity: FragmentActivity): BaseBottomSheet? {
        return super.show(activity, BottomSheetManufacturer::class.java.simpleName)
    }
    ...
    companion object {
        ...
        ): BottomSheetManufacturer {
            val fragment = BottomSheetManufacturer()
